  ...
  return (
    <div className={cn("glass rounded-[30px] p-7", highlight && "ring-1 ring-fuchsia-500/30")}>
      ...
      <div className="mt-4 flex items-center justify-center gap-2 text-xs font-medium text-slate-500">
        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-emerald-500"><rect width="18" height="11" x="3" y="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>
        תשלום מאובטח ומוצפן (Stripe 256-bit)
      </div>
    </div>
  );
}
